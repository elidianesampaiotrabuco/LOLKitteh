## LOLKitteh - Javascript based LOLCat Translator, inspired from PsXTRA
---
...
`Copyright (C) 2011-2026 by Derek Anderson / Media Upstream`
`2023-2026 by MediaStickyVideoEditor640`
